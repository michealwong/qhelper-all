#ifndef _ALTOVA_INCLUDED_sap_ALTOVA_xs_ALTOVA_CunsignedByte
#define _ALTOVA_INCLUDED_sap_ALTOVA_xs_ALTOVA_CunsignedByte
...
{
public:
	sap_EXPORT CunsignedByte(xercesc::DOMNode* const& init);
	sap_EXPORT CunsignedByte(CunsignedByte const& init);
...
#endif // _ALTOVA_INCLUDED_sap_ALTOVA_xs_ALTOVA_CunsignedByte
