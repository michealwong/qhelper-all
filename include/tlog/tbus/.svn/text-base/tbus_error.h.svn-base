...
#define TBUS_ERR_MAKE_ERROR(errno)		TBUS_ERR_MAKE(TBUS_ERR_LEVEL_ERROR, TMODID_BUS, errno + TBUS_ERR_START_ERRNO)
#define TBUS_ERR_MAKE_SEVERE(errno)		TBUS_ERR_MAKE(TBUS_ERR_LEVEL_SEVERE, TMODID_BUS, errno)
