...
#define TBUS_DEFAULT_GCIM_KEY   "1688"    /*defalt share memory key for GCIM(Global Channel Infomation Map)*/
#define TBUS_DEFAULT_GRM_KEY    "2688"    /*defalt share memory key for GRM(Global Route Map)*/
